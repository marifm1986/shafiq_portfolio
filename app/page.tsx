...
const EXPERIENCES = [
  ...
  },
  {
    ...
    description:
      "Designed full ERP modules from scratch and built finance solutions covering GL, Payroll, and Expense Management. Conducted end-user training, optimised system efficiency, and managed version control with SVN.",
...
function Navbar({ active, setActive }: { active: string; setActive: (s: string) => void }) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-[#1e1e1e] bg-[#0d0d0d]/90 backdrop-blur-md">
      ...
      {/* Mobile menu */}
      {open && (
        <div className="md:hidden bg-[#0d0d0d] border-t border-[#1e1e1e] px-6 py-4">
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center py-20">
        {/* Text */}
        <div>
          <p className="text-[#00a8ff] text-xs font-mono uppercase tracking-[0.3em] mb-4">
        ...
        <div className="flex justify-center md:justify-end">
          <div className="relative w-80 h-80">
            {/* Decorative rings */}
            <div className="absolute inset-0 rounded-2xl border border-[#00a8ff]/20 rotate-3" />
            <div className="absolute inset-0 rounded-2xl border border-[#00a8ff]/10 -rotate-2" />
            {/* Main card */}
            <div className="absolute inset-4 rounded-xl bg-[#111] border border-[#1e1e1e] flex flex-col items-center justify-center gap-4 p-6">
              {/* Avatar placeholder */}
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#00a8ff]/30 to-[#0055aa]/30 border border-[#00a8ff]/40 flex items-center justify-center text-[#00a8ff]">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 opacity-60">
                  <path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clipRule="evenodd" />
                </svg>
              </div>
              <div className="text-center">
                <p className="text-white font-semibold text-sm">Md. Shafiqul Islam</p>
                <p className="text-[#888] text-xs font-mono mt-1">9+ Years Experience</p>
              </div>
              {/* Stats */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {SKILLS.map((group) => (
            <div
              key={group.category}
              className="bg-[#111] border border-[#1e1e1e] rounded-xl p-5 hover:border-[#00a8ff]/30 transition-colors"
            >
          ...
          <div className="flex flex-col gap-12">
            {EXPERIENCES.map((exp, i) => (
              <div key={i} className="relative">
                ...
                <div className="bg-[#111] border border-[#1e1e1e] rounded-xl p-6 hover:border-[#00a8ff]/20 transition-colors">
        ...
        <div className="grid sm:grid-cols-3 gap-5 max-w-2xl mx-auto mb-10">
          {[
            ...
            <a
              key={c.label}
              href={c.href}
              className="bg-[#111] border border-[#1e1e1e] rounded-xl p-5 hover:border-[#00a8ff]/30 transition-colors text-center group"
            >
              <div className="text-[#00a8ff] flex justify-center mb-3 group-hover:scale-110 transition-transform">
                {c.icon}
              </div>
